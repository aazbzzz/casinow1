...
export const VIP_LEVELS: VIPLevel[] = [
  ...
  { level: 2, maxBet: 100000, wagerRequired: 10000, benefits: ['Mise max: 100K', 'Cashback 2%'] },
  { level: 3, maxBet: 500000, wagerRequired: 50000, benefits: ['Mise max: 500K', 'Cashback 3%'] },
  { level: 4, maxBet: 1000000, wagerRequired: 100000, benefits: ['Mise max: 1M', 'Cashback 4%'] },
  { level: 5, maxBet: 5000000, wagerRequired: 500000, benefits: ['Mise max: 5M', 'Cashback 5%'] },
  { level: 6, maxBet: 10000000, wagerRequired: 1000000, benefits: ['Mise max: 10M', 'Cashback 7%'] },
  { level: 7, maxBet: 50000000, wagerRequired: 5000000, benefits: ['Mise max: 50M', 'Cashback 10%'] },
  { level: 8, maxBet: 100000000, wagerRequired: 10000000, benefits: ['Mise max: 100M', 'Cashback 15%'] },
  { level: 9, maxBet: 500000000, wagerRequired: 25000000, benefits: ['Mise max: 500M', 'Cashback 20%'] },
  { level: 10, maxBet: Infinity, wagerRequired: 50000000, benefits: ['Mise Illimitée', 'Cashback 25%'] },
];
